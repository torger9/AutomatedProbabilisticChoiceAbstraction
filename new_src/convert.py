...
# Function gives proper call of converty.py
def usage():
    print("Usage:")
...
if interactive_mode:
    check = (input("Would you like to add a target varialbe?: ").lower().startswith('y'))
    while check:
        #temp = (input("    name of target variable: "))
        #target_vars.append(momba_model.expressions.Name(temp)]
        target_vars.append(momba_model.expressions.Name(input("    name of target variable: "))]
        check = (input("Add another target varialbe?: ").lower().startswith('y'))
     while check:
        #temp = (input("    name of important variable: "))
        #important_vars.append(momba_model.expressions.Name(temp)]
        important_vars.append(momba_model.expressions.Name(input("    name of important variable: "))]
        check = (input("Add another important varialbe?: ").lower().startswith('y'))
...
# Ensure there is only one initial state
