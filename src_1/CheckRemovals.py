...
def evaluate_possibilities(location, back_edges, incoming_state, visited, initial_state, target_location, location_value_map, depth, workfile, datafile, solved, initialheap, heapobj):
    ...
    if location in back_edges:
        ...
        for edge in back_edges[location]: 
            ...
            dest = edge.location
            print("\t\tCurrent Location: " + location.name + " (has back edges)")
            ...
            if dest == initial_state:
                print("\t\tPrevious Location:" + dest.name + " skipped (initial)")
                continue
            ...
            if dest == target_location:
                ...
                print("\t\tPrevious Location:" + dest.name + " skipped (target)")
                print("\t\t\tFinal Vals extended with: ", end = "") 
            ...
            print("\t\tPrevious Location:" + dest.name + " taken", end = "")
            ...
            print(f'\t\tEnumerating backward_vals')
        ...
        print("\t\tCurrent Location: " + location.name + " (no back edges)")
        return [incoming_state]
